...
parser.add_argument('-cid', dest='cid_file', help='the cell-id encode file, formed like data/encode_hg19.tab', default='data/encode_hg19.tab')
parser.add_argument('-e', dest='encode_path', help='the encode folder, default=/home/data/encode, encode file named as [encode_path]/[cid]_ctcf.fa',default='/home/data/encode')
# output file
parser.add_argument('-o',dest='output_path',help='the output folder, default=data/',default='data')
