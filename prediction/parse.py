...
parser.add_argument('-m', dest='mismatch', help='maximum mismatch allowed in off-target prediction, default=5', type=int, default=5, choices=range(6))
...
parser_c.add_argument('-cell', help='cell-type of gRNAs',default='K562')
parser_c.add_argument('-cid', help='cell-id file, formed like data/encode_hg19.tab', default='data/encode_hg19.tab')
parser_c.add_argument('-e', dest='encode', help='epigenomic encode folder, default=/data/genome/encode/fa/',default='/data/genome/encode/fa')
