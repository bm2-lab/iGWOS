...
parser.add_argument('gRNA',help='input your gRNA file. The input file is tab-delimited, formed like data/gRNA.tab', default='data/gRNA.tab')
...
parser.add_argument('-g', dest='genome', help='the genome path for candidate off-target searching, default=genome/hg19', default='genome/hg19')
...
parser.add_argument('cid',help='the cell-id encode file, formed like data/encode_hg19.tab',default='data/encode_hg19.tab')
# output file
